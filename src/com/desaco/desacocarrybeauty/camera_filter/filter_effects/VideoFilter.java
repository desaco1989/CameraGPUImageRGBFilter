...
package com.desaco.desacocarrybeauty.camera_filter.filter_effects;
...
public class VideoFilter implements IImageFilter {
	...
	public VideoFilter(int nVideoType) {
		...
		{
			this.pattern = new int[] { 0, 1, 2, 2, 0, 1, 1, 2, 0, };
			break;
		}
		default: {
			this.pattern = new int[] { 0, 1, 2, 0, 0, 1, 1, 1, 2, 0, 0, 1, 2, 2, 2, 0, 0, 1, 2, 0, 0, 1, 1, 1, 2, 2, 0,
					1, 2, 2, 0, 0, 0, 1, 2, 2, 0, 1, 1, 1, 2, 2, 0, 1, 2, 2, 0, 0, 0, 1, 1, 2, 0, 1, 1, 2, 2, 2, 0, 1,
					1, 2, 0, 0, 0, 1, 1, 2, 0, 1, 1, 2, 2, 2, 0, };
			break;
		}
		}
	}
