...
//
///**
// * android 图像处理滤镜系列之十 反色效果-
// * http://www.eoeandroid.com/thread-201128-1-1.html?_dsign=7082efa9
// * 
// * @author desaco
// *
// */
...
//		}
//
//		double r = colorR / 255.0, g = colorG / 255.0, b = colorB / 255.0, cmax = n_cmax / 255.0, cmin = n_cmin / 255.0,
//				delta = cmax - cmin;
//
//		if (L < 0.5)
//			S = delta / (cmax + cmin);
...
//		return Color.rgb(ImageData.safeColor((int) (r * 255)), ImageData.safeColor((int) (g * 255)),
