...
public class Gradient {
	...
	public static Gradient Fade() {
		List<Integer> colors = new ArrayList<Integer>();
		colors.add(Color.BLACK);
		colors.add(Color.rgb(0xCD, 0xE8, 0xEE));// Cornsilk2 , reference
												// http://www.wescn.com/tool/color_3.html
		colors.add(Color.BLACK);
		return new Gradient(colors);
	}
	...
	public static Gradient Scene() {
		List<Integer> colors = new ArrayList<Integer>();
		colors.add(Color.rgb(0x00, 0xD7, 0xFF));// Gold , reference
												// http://www.wescn.com/tool/color_3.html
		colors.add(Color.WHITE);
	...
	public static Gradient Scene1() {
		List<Integer> colors = new ArrayList<Integer>();
		colors.add(Color.rgb(0xED, 0x95, 0x64));// CornflowerBlue , reference
												// http://www.wescn.com/tool/color_3.html
		colors.add(Color.WHITE);
	...
	public static Gradient Scene2() {
		List<Integer> colors = new ArrayList<Integer>();
		colors.add(Color.rgb(0xFF, 0xBF, 0x00));// DeepSkyBlue , reference
												// http://www.wescn.com/tool/color_3.html
		colors.add(Color.WHITE);
	...
	public static Gradient Scene3() {
		List<Integer> colors = new ArrayList<Integer>();
		colors.add(Color.rgb(0x00, 0xa5, 0xff));// , reference
												// http://www.wescn.com/tool/color_3.html
		colors.add(Color.WHITE);
