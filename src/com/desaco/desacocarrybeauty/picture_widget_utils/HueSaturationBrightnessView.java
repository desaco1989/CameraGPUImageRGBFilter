...
/**
 * 图片色调饱和度、色相、亮度处理 https://blog.csdn.net/sjf0115/article/details/7267063
 * 
 * @author desaco
 *
 */
public class HueSaturationBrightnessView {
	/**
	 * 饱和度标识
	 */
	...
	public HueSaturationBrightnessView(Context context) {
		init(context);
	}
	...
	private void init(Context context) {
		...
		saturation.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT));

		LinearLayout.LayoutParams txtLayoutparams = new LinearLayout.LayoutParams((int) (TEXT_WIDTH * mDensity),
		...
		hue.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT));
		...
		lum.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT));
