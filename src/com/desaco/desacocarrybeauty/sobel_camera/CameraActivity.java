package com.desaco.desacocarrybeauty.sobel_camera;
...
public class CameraActivity extends Activity implements
	...
	//com.desaco.desacocarrybeauty.sobel_camera.CameraActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSavePhotoBtn.setOnClickListener(new OnClickListener() {
			@Override
	...
	public void onCameraStopped(byte[] data) {
		progressDialog = ProgressDialog
				.show(CameraActivity.this, "请稍后", "正在处理");
		progressDialog.setCancelable(false);
	...
	public void onAutoFocus(boolean success) {
		if (!success) {
			Toast.makeText(CameraActivity.this, "对焦失败", Toast.LENGTH_LONG);
		}
	}
		...
		return new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case SAVE_PHOTO_ERROR:
					...
					Toast.makeText(CameraActivity.this, "保存失败",
							Toast.LENGTH_LONG);
					break;
				default:
					break;
